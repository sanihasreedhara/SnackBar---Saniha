                            ...
                            implements ActionListener
{
  ...
  {
	Color period = new Color(252, 230, 236);
    ...
    Color slay = new Color(245,103,164);
    Color slay2 = new Color(255,110,131);
    Color slay3 = new Color(249,181,181);
    
    go = new JButton("   ");
    go.setBackground(slay);
    go.addActionListener(this);
    JPanel buttons = new JPanel(new GridLayout(3, 1, 5, 0));
    buttons.setBackground(slay2);
